...
<?php
     ...
     $sqlBolsas = mysqli_query($conexao, "SELECT bolID, bolModelo, bolFabricante FROM bolsa".
...
?>
        ...
        <tr>
            <td width="10%"><div align="center"><b><font face="Arial" size="2">Código</font></b></div></td>
