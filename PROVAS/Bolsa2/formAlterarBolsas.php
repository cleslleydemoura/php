 ...
 <div class="nav-bar-fixed">
    ...
    ?>
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"];?>">
            <p>Código da Bolsa: <input type="text" name="bolID" size="10">
            <input type="submit" value="Alterar Dados do Bolsa" name="alterar"></p>
            <div align="left"><font face="Arial" size="2"><b>Não Lembra o Código?<a href='pesqTodasBolsas.php'> Clique Aqui </a><br/></font></div>
        </form>
        <?php
        }
        ...
        ?>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
                ...
                <tr>    
                    <td width="5%"><div align="center"><b><font face="Arial" size="2">Código</font></b></div></td>         
                ...
                <tr>
                    ...
                    <td width="10%" height="25"><b><font face="Arial" size="2"><input type="text" name="bolFabricante" required value="<?php echo $bolFabricante;?>"></font></td>     
                </tr>
            </table>
        ...
        else // alterar Bolsa
        {
            ...
            $altera = mysqli_query($conexao, "UPDATE bolsa SET bolModelo='$bolModelo', bolFabricante='$bolFabricante' WHERE bolID='$bolID'");
